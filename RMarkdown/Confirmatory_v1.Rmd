...
#Local data
localfolder <- paste0(dirname(localfolder), '/dataset/') #THIS WILL NEED TO POINT TO A DATASET FOLDER WHERE THE RAW DATA IS DOWNLOADED TO
