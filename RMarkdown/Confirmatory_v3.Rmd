...
First we report whether our manipulation of movement vs. no movement (binary comparison) indeed increases postural and muscle activity. As expected, the increased activity of muscles, except the rectus abdominis, is confirmed by comparing mixed regression models (participant as random intercept) predicting magnitude of the peak muscle activity with a movement vs. no movement predictor included, versus a model predicting the overall mean.
...
We assessed whether there is an effect of weight in movement-only conditions over and above a model that includes a movement predictor. We find that weight indeed affects all measured muscle activity except the rectus abdominis. Weight also affects kinematics, confirmed the lower speeds and accelerations for when moving with a weight (Table S1, Figure S4). However, the weight did not find statistically reliable effects of weight on the change in the center of pressure.
...
We planned three confirmatory analyses as outlined in the pre-registration, where we assessed whether:

#### 1. Movement and weight conditions have (different) effects on vocalization amplitude

**H0 I:** The movement and weight conditions, as compared to control movement conditions (passive, no weight conditions) do not affect vocalization amplitude.

#### 2. Muscle Activity Effects on Vocalization Amplitude

**H0 II:** Muscle activity (differentially) affects amplitude of vocalization

#### 3. Postural muscle activity is related to postural stability (change in center of pressure)

**H0 III:** No muscle activity is related to postural stability in any of the conditions.
...
### Research Question 2: Do movement and weight conditions have (different) effects on vocalization amplitude?{#analysis-2}
...
## Exploratory confounding analysis
### Exploratory confounding analysis for the issue of causality
...
<aside>
<span style="color: red;"> This refers to Figure 5 in the paper. Note in the current Rmarkdown we retain the rectus abdominis. As can be seen the z-normalization inflates the noise of the rectus abdominis as there is not a lot of variability across conditions.
</span>
</aside> 

### Exploratory confounding analysis for subtle differential effects on vocalization
...
```
<aside>
<span style="color: red;"> This refers to Figure 6 in the paper.
</span>
</aside> 

### Exploratory confounding analysis: Muscle activity for the different movement and vocalization conditions
...
```{r movementpeakmuscleactivity1, echo = FALSE, fig.cap = "Muscle and postural activations for vocalization versus expiration.", fig.height = 20}
...
<aside>
<span style="color: red;">
Part of this figure is reused for Figure 7 in the paper.
</span>
</aside>
